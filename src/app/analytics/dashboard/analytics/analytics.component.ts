...
export class AnalyticsComponent implements OnInit {
  ...
  public text = "Distribution Of Trips by days";
  ...
  trendSearch() {
    ...
    if(this.status_filter == "3") {
      this.yAxisLabel = "Refunded Orders";
      this.analytics = this.refundedOrdersArray;
      this.text = "Distribution Of Refunded Orders By Days";
    }
  }
